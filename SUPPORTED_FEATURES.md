| Feature | roborock.vacuum.a15 | roborock.vacuum.a87 | roborock.vacuum.s5e |
|---|---|---|---|
| Product Nickname | TANOSS | PEARLPLUS | RUBYSLITE |
| Protocol Version | 1.0 | 1.0 | 1.0 |
| New Feature Info | 636084721975295 | 4499197267967999 | 633887780925447 |
| New Feature Info Str | 0000000000002000 | 508A977F7EFEFFFF | 0000000000002000 |
| `111` | X | X | X |
| `112` | X | X | X |
| `113` | X | X | X |
| `114` | X | X | X |
...
| `is_collect_dust_mode_supported` | X | X | X |
| `is_corner_clean_mode_supported` |  |  |  |
| `is_corner_mop_stretch_supported` |  | X |  |
| `is_ctm_with_repeat_supported` |  |  |  |
| `is_current_map_restore_enabled` | X | X | X |
| `is_custom_clean_mode_count_supported` |  | X |  |
| `is_custom_mode_supported` | X | X | X |
| `is_custom_water_box_distance_supported` |  | X | X |
...
| `is_led_status_switch_supported` | X | X | X |
...
| `is_multi_floor_supported` | X | X | X |
| `is_multi_map_segment_timer_supported` | X | X | X |
...
| `is_order_clean_supported` | X | X | X |
...
| `is_re_segment_supported` | X | X | X |
| `is_record_allowed` | X | X |  |
| `is_remote_supported` | X | X | X |
| `is_right_brush_stretch_supported` |  |  |  |
| `is_room_name_supported` | X | X | X |
...
| `is_show_clean_finish_reason_supported` | X | X | X |
...
| `is_support_fetch_timer_summary` | X | X | X |
...
| `is_support_quick_map_builder` | X | X | X |
...
| `is_unsave_map_reason_supported` | X | X | X |
